 ...
 */
public class SaveSingleValueToPathBox extends Box implements Serializable {
    ...
    public SaveSingleValueToPathBox(int x, int y) {
        ...
        filenameParameter = addValueParameter("wert.txt", "Dateiname (Wenn Feld leer wird Zeitstempel verwendet):", 100);
    ...
    public static String NAME = "Wert in Pfad speichern";
