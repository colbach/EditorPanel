 ...
 */
public class ValueArraySwitchBox extends Box implements Serializable {
    
    private static final long serialVersionUID = 1L;
    private MultipleOptionsParameter op;
    
    
    public ValueArraySwitchBox(int x, int y) {
    ...
    public static String NAME = "Werte-Array umschalten";
