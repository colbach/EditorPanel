 ...
 */
public class SaveTrueFalseToPathBox extends Box implements Serializable {
    ...
    public SaveTrueFalseToPathBox(int x, int y) {
        ...
        filenameParameter = addValueParameter("boolean.txt", "Dateiname (Wenn Feld leer wird Zeitstempel verwendet):", 100);
    ...
    public static String NAME = "Wahrheitswert in Pfad speichern";
