 ...
 */
public class SaveValueArrayToPathBox extends Box implements Serializable {
    ...
    public SaveValueArrayToPathBox(int x, int y) {
        ...
        filenameParameter = addValueParameter("array.txt", "Dateiname (Wenn Feld leer wird Zeitstempel verwendet):", 100);
    ...
    public static String NAME = "Werte-Array in Pfad speichern";
