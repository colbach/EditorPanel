 ...
 */
public class SaveValueArrayViaDialogBox extends Box implements Serializable {
    
    private static final long serialVersionUID = 1L;
    ToogleParameter disableParameter;

    public SaveValueArrayViaDialogBox(int x, int y) {
    ...
    public static String NAME = "Werte-Array via Dialog speichern";
