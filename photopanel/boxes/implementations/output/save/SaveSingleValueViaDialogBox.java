 ...
 */
public class SaveSingleValueViaDialogBox extends Box implements Serializable {
    
    private static final long serialVersionUID = 1L;
    ToogleParameter disableParameter;

    public SaveSingleValueViaDialogBox(int x, int y) {
    ...
    public static String NAME = "Wert via Dialog speichern";
