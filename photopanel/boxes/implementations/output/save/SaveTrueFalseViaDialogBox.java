 ...
 */
public class SaveTrueFalseViaDialogBox extends Box implements Serializable {
    
    private static final long serialVersionUID = 1L;
    ToogleParameter disableParameter;

    public SaveTrueFalseViaDialogBox(int x, int y) {
    ...
    public static String NAME = "Wahrheitswert via Dialog speichern";
